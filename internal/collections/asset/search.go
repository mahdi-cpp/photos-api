...
var LessFunks = map[string]search.LessFunction[*Asset]{
	"id":        func(a, b *Asset) bool { return a.ID.String() < b.ID.String() },
	"createdAt": func(a, b *Asset) bool { return a.CreatedAt.Before(b.CreatedAt) },
	"updatedAt": func(a, b *Asset) bool { return a.UpdatedAt.Before(b.UpdatedAt) },
}

func GetLessFunc(sortBy, sortOrder string) search.LessFunction[*Asset] {
	...
	if sortOrder == "desc" {
		return func(a, b *Asset) bool { return !fn(a, b) }
	}
	return fn
}

func BuildPHAssetCriteria(with *SearchOptions) search.Criteria[*Asset] {

	return func(c *Asset) bool {
...
func Search(chats []*Asset, with *SearchOptions) []*Asset {
